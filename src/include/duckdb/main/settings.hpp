...
struct RandomTaskOrderSetting {
    using RETURN_TYPE = bool;
    static constexpr const char *Name = "random_task_order";
    static constexpr const char *Description = "DEBUG SETTING: randomize the order tasks are dequeued from the task scheduler for stress-testing";
    static constexpr const char *InputType = "BOOLEAN";
